    ...
    <nav>
        <ul>
            ...
            if (isset($_SESSION['username'])) {
                echo '<li style="border: 1px solid white;"><a href="pages/logout.php">Esci</a></li>';
            } else {
                echo '<li style="border: 1px solid white;"><a href="pages/login.php">Accedi</a></li>';
            }
            ?>
        </ul>
    </nav>
...
<div id="cookie-popup" class="cookie-popup">
    <p>Questo sito utilizza i cookie per garantire la migliore esperienza di navigazione possibile. <a href="pages/policy.php">Scopri di più</a>.</p>
